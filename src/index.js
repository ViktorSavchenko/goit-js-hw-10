...
import { fetchCountries } from './js/newFetch.js';
...
function createMarkupCountry({
  ...
  <p class='country__capital'>Capital: <span class='country__descr'>${capital}</span></p> 
  <p class='country__population'>Population: <span class='country__descr'>${population}</span></p>
  <p class='country__language'>Languages: <span class='country__descr'>${countryLanguages}</span></p>  
  `;
}
